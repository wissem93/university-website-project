					...
					<div class="navbar-collapse collapse ">
						<ul class="nav navbar-nav">
							...
							<li class="active" class="dropdown"><a href="#"
								...
								data-hover="dropdown" data-delay="0" data-close-others="false">Actualités
				...
				<div class="col-sm-12">
					...
					<div class="col-xs-3">
						...
						<ul class="nav  tabs-left">
							...
							<li><a href="#profile" data-toggle="tab">Enseignant</a><br></li>
					...
					<div class="col-md-9">
						...
						<div class="tab-content ">
							...
							<div class="tab-pane active" id="home">
								<select name="emploietud" class="form-control">
									<c:forEach items="${etudiants}" var="p">
										<option value="infoetudiant?idetud=${p.iduser }">${p.nomuser}${p.prenom }</option>
									</c:forEach>
									<script type="text/javascript">
										function load() {
											var e = document
													.getElementById("emploietud");
								...
								</select> <br> <a onclick="load();" class="btn btn-success"><i
									onclick="load();" class="fa fa-heart"></i> valider</a>

							</div>


							<div class="tab-pane" id="profile">
								<select name="emlpoienseign" id="idens" class="form-control">
									<c:forEach items="${enseignants}" var="p">
										<option value="infoenseignant?ide=${p.iduser }">${p.nomuser}${p.prenom }</option>

									</c:forEach>
									<script type="text/javascript">
										function load() {
											var e = document
													.getElementById("idens");
							...
							<div class="tab-pane" id="messages">
								<select name="thelist" class="form-control ">
									<option>cal1</option>
									<option>cal2</option>
									<option>cal3</option>
									<option>cal4</option>
								</select> <br> <a href="#" class="btn btn-success"><i
									class="fa fa-heart"></i> valider</a>
							</div>
