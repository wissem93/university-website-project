...
<div class="row">
    <div class="col-xs-12 col-sm-8 col-md-6 col-sm-offset-2 col-md-offset-3">
		<form role="form"  action="AddSujet" method="post" class="register-form">
			<h2>Please Ajouter votre Sujet <small></small></h2>
			<hr class="colorgraph">
			<div class="row">
				<div class="form-group">
					<div class="form-group">
                        <input type="text" name="titre" id="name" class="form-control input-lg" placeholder="titre" tabindex="1">
					</div>
				</div>
			
			
			<div class="form-group">
				<input type="text" name="categorie" id="categorie" class="form-control input-lg" placeholder="Categorie" tabindex="4">
			</div>
