				...
				<div class="row">
						...
						<div class="widget">
							...
							<ul class="cat">
								<li><i class="fa fa-angle-right"></i>
									<th>nom</th>
									<th><c:out value='${etud.nomuser}' /></th>
									</tr></li>
								<li><i class="fa fa-angle-right"></i>
									<th>prenom</th>
									<th><c:out value='${etud.prenom}' /></th>
									</tr></li>
								<li><i class="fa fa-angle-right"></i>
									<th>E-mail</th>
									<th><c:out value='${etud.email}' /></th>
									</tr></li>

								<li><i class="fa fa-angle-right"></i>
									<th>Telephone</th>
									<th><c:out value='${etud.telephone}' /></th>
									</tr></li>


								<li><i class="fa fa-angle-right"></i>
									<th>Classe</th>
									<th><c:out value='${classe.nomClasse}' /></th>
									</tr></li>


								<li><i class="fa fa-angle-right"></i>
									<th>Filiere</th>
									<th><c:out value='${filier.nomFiliere}' /></th>
									</tr></li>
					...
					<div class="col-lg-4">
						...
						<div class="widget">
							...
							<ul class="tags">
								<li><a href="getalletudiantenseignant">enseingnant </a></li>
								<li><a href="#"> Cour </a></li>
								<li><a href="#"> Club </a></li>
				...
				<div class="row">
					...
					<div class="col-lg-6">
						...
						<dl class="dl-horizontal">
							...
							<dt>
								<c:out value="${note.urlRsource}"></c:out>
							</dt>
							<dd>Vestibulum id ligula porta felis euismod semper eget
								lacinia odio sem nec elit.</dd>
							<dd>Donec id elit non mi porta gravida at eget metus.</dd>
						...
						<div class="col-sm-3 col-lg-3">
							<div class="widget">
								...
								<ul class="link-list">
									...
									<li><a href="infoclub?idc=${p.idclub }">${p.caractere}</a></li>
