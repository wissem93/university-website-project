        ...
        <div class="navbar navbar-default navbar-static-top">
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="indexservlet"><img src="img/logo.png" alt="" width="199" height="52" /></a>
                </div>
                <div class="navbar-collapse collapse ">
                    <ul class="nav navbar-nav">
                                <li ><a href="indexservlet">Accueil</a></li>
                                <li><a href="apropos.html">A propos de L'ISSAT</a></li>
                         
						 <li class="dropdown">
                            <a href="#" class="dropdown-toggle " data-toggle="dropdown" data-hover="dropdown" data-delay="0" data-close-others="false">Actualités <i class="fa fa-angle-down"></i></a>
                        ...
                        <li class="dropdown">
                            <a href="#" class="dropdown-toggle " data-toggle="dropdown" data-hover="dropdown" data-delay="0" data-close-others="false">Formation<i class="fa fa-angle-down"></i></a>
                            <ul class="dropdown-menu">
                                <li><a href="formationprep.html">Formation Preparatoire</a></li>
                                <li><a href="formationlicence.html">Formation licence </a></li>
								<li><a href="formationmastere.html">Formation Mastere</a></li>
								<li><a href="formationing.html">Formation Ingenieur</a></li>
                            </ul>
                        </li>
                        
                        <li class="dropdown"><a href="#" class="dropdown-toggle " data-toggle="dropdown" data-hover="dropdown" data-delay="0" data-close-others="false">Entreprenariat <i class="fa fa-angle-down"></i></a>
							<ul class="dropdown-menu">
...
<div class="row">
    <div class="col-xs-12 col-sm-8 col-md-6 col-sm-offset-2 col-md-offset-3">
		<form role="form" class="register-form" method="post" action="LoginEtudiantServlet">
...
<select name="thelist" class="form-control input-lg" >
  <option>Etudiant</option>
  <option>Enseingnant</option>
  ...
  <option>Administrateur</option>
			...
			<div class="form-group">
				<input type="password" name="pwd" class="form-control input-lg" id="exampleInputPassword1" placeholder="Password">
			</div>
