...
<div class="row">
    <div class="col-xs-12 col-sm-8 col-md-6 col-sm-offset-2 col-md-offset-3">
		<form role="form"  action="AddNote" method="post" class="register-form">
			<h2>Please Ajouter les note<small></small></h2>
			<hr class="colorgraph">
			<div class="row">
			...
			<div class="form-group">
				<input type="email" name="urlRsource" id="urlRsource" class="form-control input-lg" placeholder="urlnote" tabindex="4">
			</div>
